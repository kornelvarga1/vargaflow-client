 ...
 * Payload: { business_id, contact_id, contact_first_name, star_rating, feedback_text }
 *
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { business_id, contact_id, contact_first_name, star_rating, feedback_text } = body;
